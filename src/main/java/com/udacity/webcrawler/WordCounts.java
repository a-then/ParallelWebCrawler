...
final class WordCounts {
   ...
   *   First sorting by word count, ranking more frequent words higher.
   *   Then sorting by word length, ranking longer words higher.
   *   Finally, breaking ties using alphabetical order.
   */
